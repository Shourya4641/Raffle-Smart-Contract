...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    /**
     * when we inherit from any smart contract then we have to integrate the constructor of the inheritted contract to
     * the child contract.
     */
    constructor(
        uint256 entranceFee,
    ...
    function enterRaffle() external payable {
        if (msg.value < i_entranceFee) {
            revert Raffle__SendMoreEthToEnterRaffle(); // gas efficient
        }
        ...
        // emiting events after updating any storage variable helps in-
        // 1. contract migration
        // 2. making the frontend integration easier
